...
/**
 * @namespace zark::planning::common
 * @brief zark::planning::common
 */
namespace zark {
namespace planning {
namespace common {
...
class VehicleConfigHelper {
 public:
   ...
   * pointed by gflags PlanningGflags::vehicle_config_path. The code will crash
   * if PlanningGflags::vehicle_config_path does not exist or it points to a
   ...
   */
  static void Init(const planning::common::VehicleConfig &config);
   ...
   */
  static const planning::common::VehicleConfig &GetConfig();
   ...
   */
  ::math::Box2d GetBoundingBox(const ::common::PathPoint &path_point);

 private:
  static planning::common::VehicleConfig vehicle_config_;
