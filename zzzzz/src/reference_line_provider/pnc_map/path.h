...
class MapPathPoint : public ::math::Vec2d {
 public:
  ...
  static std::vector<MapPathPoint> GetPointsFromLane(
...
class PathApproximation {
 public:
  ...
  bool OverlapWith(const Path& path, const Box2d& box, double width) const;
...
class Path {
 public:
  ...
  bool GetHeadingAlongPath(const ::math::Vec2d& point, double* heading) const;
