#include "math/quintic_polynomial_curve1d.h"
namespace e2e_noa {
namespace planning {
...
std::string QuinticPolynomialCurve1d::ToString() const {
  std::string log_str;
  log_str = "s:" + std::to_string(end_condition_[0]) +
            "   v:" + std::to_string(end_condition_[0]) +
            "   a:" + std::to_string(end_condition_[1]) +
            "   t:" + std::to_string(param_);
