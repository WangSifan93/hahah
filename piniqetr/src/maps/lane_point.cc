...
void FindNeighboringVerticesWithSuccessorLane(
    const ad_e2e::planning::MapConstPtr& map_ptr, ElementId lane_id,
...
void FindNeighboringVertices(const ad_e2e::planning::MapConstPtr& map_ptr,
...
Vec2d LanePoint::ComputePos(
    const ad_e2e::planning::MapConstPtr& map_ptr) const {
