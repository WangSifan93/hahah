#ifndef AD_E2E_PLANNING_COMMON_STATUS_BASE_H
#define AD_E2E_PLANNING_COMMON_STATUS_BASE_H
...
CEREAL_REGISTER_TEMPLATE(::ad_e2e::planning::StatusBase::InfoProxy)
