...
#include "common/speed/speed_profile_utils.h"
...
SpeedProfilePtr ConstantAccBuilder::Build(const SpeedPoint &start,
  ...
  // a * v should be positive, otherwise it is not a valid speed profile
  ...
  auto speed_point = CalConstJerkSpeedPoint(start, jerk, t); // const jerk speed point 
  bool reach_target_v =
