...
from mcts.pack_extraction_to_json import pack_extraction_to_json, single_pack_to_dataset

parser = argparse.ArgumentParser("visual_pnc_online")
parser.add_argument("file", help="Path to input directory or .pack file")
...
if __name__ == "__main__":
    ...
    if os.path.isdir(args.file):
        folders = pack_extraction_to_json(filename)
    else:
        file = single_pack_to_dataset(filename)
        dir_show(str(file))
