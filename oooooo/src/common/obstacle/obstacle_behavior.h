#ifndef AD_E2E_PLANNING_COMMON_OBSTACLE_OBSTACLE_BEHAVIOR_H
#define AD_E2E_PLANNING_COMMON_OBSTACLE_OBSTACLE_BEHAVIOR_H

#include <vector>

#include "common/obstacle/prediction_constrain.h"
...
using LaneConstPtr = std::shared_ptr<const ::ad_e2e::planning::Lane>;
