...
class RefSCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit RefSCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::REF_S_COST; }
