...
class RefVCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit RefVCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::REF_V_COST; }
