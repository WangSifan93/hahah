...
class DDKappaCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit DDKappaCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::DDKAPPA_COST; }
