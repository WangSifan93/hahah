...
class RefpathCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit RefpathCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::REF_PATH_COST; }
