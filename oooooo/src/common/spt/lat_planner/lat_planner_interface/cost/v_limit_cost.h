...
class VLimitCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit VLimitCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::V_LIMIT_COST; }
