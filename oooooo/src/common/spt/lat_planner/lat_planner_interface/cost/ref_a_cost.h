...
class RefACost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit RefACost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::REF_A_COST; }
