...
class DJerkCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit DJerkCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::DJERK_COST; }
