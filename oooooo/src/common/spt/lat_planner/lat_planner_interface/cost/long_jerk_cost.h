...
class LONGJerkCost : public CostBase<STATE_SIZE, INPUT_SIZE> {
 public:
  explicit LONGJerkCost(const LatSptDataCache &data) : spt_data_(data) {}
  ...
  std::uint8_t GetCostId() const override { return CostList::LONG_JERK_COST; }
