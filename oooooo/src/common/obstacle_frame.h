#ifndef AD_E2E_PLANNING_COMMON_OBSTACLE_FRAME_H
#define AD_E2E_PLANNING_COMMON_OBSTACLE_FRAME_H

#include <string>
#include <unordered_set>

#include "common/input_frame.h"
#include "common/obstacle/lane_graph.h"
#include "common/obstacle/obstacle_behavior.h"
#include "common/prediction_trajectory.h"
...
using MathVec2d = ::ad_e2e::planning::math::Vec2d;
...
class ObstacleFrame {
 public:
  ...
  void SetIsSpacetime(const bool is_spacetime);
  ...
  bool is_spacetime() const { return is_spacetime_; }
