#ifndef AD_E2E_PLANNING_COMMON_VECTOR_POLYLINE_H
#define AD_E2E_PLANNING_COMMON_VECTOR_POLYLINE_H
...
class LanePolyline : public Polyline {
 ...
 private:
  ...
  std::size_t lane_polyline_vector_size_ =
      FLAGS_ad_e2e_planning_lane_polyline_vector_num;
  std::size_t lane_vector_dim_ = FLAGS_ad_e2e_planning_lane_vector_dim;
};
...
class LaneBoundaryPolyline : public Polyline {
 ...
 private:
  ...
  std::size_t lane_boundary_polyline_vector_size_ =
      FLAGS_ad_e2e_planning_road_boundary_polyline_vector_num;
  std::size_t lane_boundary_vector_dim_ =
      FLAGS_ad_e2e_planning_road_boundary_vector_dim;
};
...
class PolygonPolyline : public Polyline {
 ...
 private:
  ...
  std::size_t polygon_polyline_vector_size_ =
      FLAGS_ad_e2e_planning_polygon_polyline_vector_num;
  std::size_t polygon_polyline_vector_dim_ =
      FLAGS_ad_e2e_planning_polygon_polyline_vector_dim;
};
