#ifndef PLANNER_SCHEDULER_SMOOTH_REFERENCE_LINE_RESULT_H_
#define PLANNER_SCHEDULER_SMOOTH_REFERENCE_LINE_RESULT_H_
...
struct SmoothedReferenceCenterResult {
  absl::flat_hash_map<e2e_noa::mapping::ElementId,
